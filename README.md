...
### BPGA
**Caution:**
- This package requires GenBank files annotated using **<mark>GeneMarkS2+**<mark>. GenBank files from other annotation pipelines may cause unexpected errors due to differences in file structure.
